...
def cluster_model_pipeline(DF, API_KEY, GPT_MODEL,openai_api_model_type,openai_api_base_url):
    st.divider()
    st.subheader('数据概述')
        ...
        with st.container():
            ...
            if not st.session_state["decided_model"]:
                with st.spinner("Deciding models based on data..."):
                    ...
                    model_dict = decide_cluster_model(shape_info, description_info, cluster_info, GPT_MODEL, API_KEY,openai_api_model_type,openai_api_base_url)
