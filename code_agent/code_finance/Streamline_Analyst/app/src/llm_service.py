...
def decide_encode_type(attributes, data_frame_head, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
    ...
    try:
        ...
        llm = ChatOpenAI(model_name=openai_api_model_type, openai_api_key=user_api_key, base_url=openai_api_base_url,
                         temperature=0)
...
def decide_fill_null(attributes, types_info, description_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
...
def decide_model(shape_info, head_info, nunique_info, description_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
...
def decide_cluster_model(shape_info, description_info, cluster_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
...
def decide_regression_model(shape_info, description_info, Y_name, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
...
def decide_target_attribute(attributes, types_info, head_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
    Determines the target attribute for 建模中 based on dataset attributes and characteristics.
    ...
    try:
        model_name = model4_name if model_type == 4 else model3_name
        user_api_key = api_key if user_api_key is None else user_api_key
        llm = ChatOpenAI(model_name=openai_api_model_type, openai_api_key=user_api_key,base_url=openai_api_base_url, temperature=0)
...
def decide_test_ratio(shape_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
...
def decide_balance(shape_info, description_info, balance_info, model_type = 4, user_api_key = None,openai_api_model_type = None,openai_api_base_url = None):
    """
