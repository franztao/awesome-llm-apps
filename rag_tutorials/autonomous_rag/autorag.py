...
def main():
    ...
    as LLM API Key, PDF uploads, and user questions, and interacts with an
    ...
    Side Effects:
        ...
        - Prompts users to input an LLM API Key and a question.
        - Allows users to upload PDF documents.
        - Displays responses generated by querying an assistant.

    Raises:
        StreamlitWarning: If the LLM API Key is not provided."""
    ...
    if not api_key:
        st.sidebar.warning("Enter your LLM API Key to proceed.")
        st.stop()
